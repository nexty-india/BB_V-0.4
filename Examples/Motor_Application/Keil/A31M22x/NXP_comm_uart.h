...
#define TIME_TO_TRANSMIT_MS  			(1000 *(TOTAL_BYTE + BUFFER_SIZE)/BAUD_RATE_UART)
...
typedef enum{
	...
	UART_FRAME_INDEX_READ_DEVICE_ID						,           
	UART_FRAME_INDEX_READ_AC_VOLTAGE,          
	UART_FRAME_INDEX_READ_MOTOR_CURRENT,       
	UART_FRAME_INDEX_READ_DC_VOLTAGE,          
	UART_FRAME_INDEX_READ_DC_CURRENT,         
	UART_FRAME_INDEX_WRITE_FAN_TARGET_SPEED,   
	UART_FRAME_INDEX_READ_ACTUAL_SPEED,        
	UART_FRAME_INDEX_READ_IPM_TEMPERATURE,     
	UART_FRAME_INDEX_READ_MOTOR_TEMPERATURE,   
	UART_FRAME_INDEX_SET_MOTOR_STATUS,         
	UART_FRAME_INDEX_READ_FAULT_STATUS,        
	UART_FRAME_INDEX_READ_KW,                  
	UART_FRAME_INDEX_READ_KWH,                 
	UART_FRAME_INDEX_READ_TORQUE,              
//	UART_FRAME_INDEX_READ_LOAD,  
  UART_FRAME_INDEX_LED_STATUS,  
	UART_FRAME_INDEX_FAULT_CLEAR_STATUS,
	UART_FRAME_INDEX_FAULT_FREQUENCY,
	UART_FRAME_TOTAL_INDEX,
}TRANSMIT_PARA_t;
